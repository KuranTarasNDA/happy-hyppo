    ...
    <div class="container">
      <div class="search__item">
        ...
        <div class="search__input">
          <input id="search" type="text" placeholder="By name or  email">
